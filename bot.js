...
randomLang = languageList[Math.round(Math.random() * 184 + 1)].code;
...
const options = {
  ...
  headers: {
    ...
    'X-RapidAPI-Key': '85e88a2c00msh8e34c497819c463p109735jsnfec13e7f2205',
...
axios.request(options).then(function (response) {
	var newTweetText = response.data;
